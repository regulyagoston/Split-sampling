** SIMULATION function for Chan-Matyas-Reguly (2021): Modelling with Discretized Ordered Choice Models
...
set seed 1234
if ( "`2'" == "manski" ){
	simulate lb=e(lb_1) ub=e(ub_1), reps(1000): simul_LHS `1' `2' `3' `4' `5'
}
else {
	simulate _b _se conv=r(conv), reps(1000): simul_LHS `1' `2' `3' `4' `5'
}
